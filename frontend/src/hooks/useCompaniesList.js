...
import { getCompaniesByStatus } from "@/services/company_service";
...
export default function useCompaniesList() {
  ...
  const [searchType, setSearchType] = useState("company_name");
  ...
  const loadCompanies = useCallback(async () => {
    ...
    try {
      ...
      const payload = await getCompaniesByStatus(activeStatus, {
        params: {
          page,
          page_size: pageSize,
          cursor,
